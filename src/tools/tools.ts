...
server.tool("place-order", "Places a buy or sell order for stocks/instruments on Zerodha. Supports multiple order types (MARKET, LIMIT, SL, SL-M), products (CNC, MIS, NRML), and exchanges (NSE, BSE). Default settings: variety='amo', exchange='NSE', product='CNC', order_type='MARKET'", 
  { 
    stock: z.string(), 
    quantity: z.number(), 
